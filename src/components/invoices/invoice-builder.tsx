...
interface InvoiceBuilderProps {
  initialData?: InvoiceFormValues & { id: string; invoiceNumber: string }
  customerId?: string
}

export function InvoiceBuilder({ initialData, customerId }: InvoiceBuilderProps) {
          ...
          <CardContent className="pt-6">
            ...
            <div className="space-y-4">
              {fields.map((field, index) => (
                <div key={field.id} className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-end border-b pb-4">
            ...
            <div className="flex flex-col items-end mt-8 space-y-2">
              ...
              <div className="flex justify-between w-full sm:w-64 font-bold text-md text-red-600">
                <span>Balance Due:</span>
                <span>${((form.watch('total') || 0) - (form.watch('amountPaid') || 0)).toFixed(2)}</span>
              </div>
            </div>
          </CardContent>
        </Card>
